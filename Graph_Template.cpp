...
class Graph{
    ...
    void Remove_Edge_Directed(int startv,int endv,int weight=0)
    {
    ...
    void Shortest_path_Djakstra(int source)
    {
        reset();
    ...
    bool Shortest_path_BellmanFord(int source)
    {
        reset();
        bfs_src_distances[source]=0;
    ...
    {
        cout<<endl<<"Shortest Path Cost:"<<bfs_src_distances[dest]<<endl;
        cout<<"Path: ";
        trace_path_rec(dest);
        cout<<endl;
...
*/
 /*   int num_of_vertices,num_of_edges,u,v;
    ...
    */
    ...
    cin>>src>>dest;
    //X.print();
    if(X.Shortest_path_BellmanFord(src))
    {
