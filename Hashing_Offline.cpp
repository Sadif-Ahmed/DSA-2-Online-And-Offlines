...
int main()
{
    ...
    Hash_table table1 = Hash_table((long long)N*0.4,1);
    Hash_table table2 = Hash_table((long long)N*0.5,1);
    Hash_table table3 = Hash_table((long long)N*0.6,1);
    Hash_table table4 = Hash_table((long long)N*0.7,1);
    Hash_table table5 = Hash_table((long long)N*0.8,1);
    Hash_table table6 = Hash_table((long long)N*0.9,1);

    for(long long i=0;i<N;i++)
    {
        table1.insert(dump[i],i+1);
        table2.insert(dump[i],i+1);
        table3.insert(dump[i],i+1);
        table4.insert(dump[i],i+1);
        table5.insert(dump[i],i+1);
        table6.insert(dump[i],i+1);
    }
    */

    Hash_table h1 = Hash_table(N*0.5,5);
    h1.insert("baba",1);
    h1.insert("ma",2);
    h1.insert("dada",3);
